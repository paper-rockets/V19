...
export const TelemetryPanel: React.FC<TelemetryPanelProps> = ({
  ...
  const highlightCol = isSage ? 'text-[#d35f4c]' : isDark ? 'text-neutral-200' : 'text-neutral-900';
  const mutedCol = isSage ? 'text-[#232628]/60' : isDark ? 'text-neutral-400' : 'text-neutral-500';

  return (
    <div className={`flex flex-col h-full border-l ${borderCol} ${panelBg} font-mono text-xs select-none p-4 overflow-hidden`}>
