...
const bridgeContent = `import { invoke } from '@tauri-apps/api/core';
...
fs.writeFileSync(path.resolve('src/core/tauriBridge.ts'), bridgeContent, 'utf-8');
console.log('src/core/tauriBridge.ts created successfully.');
